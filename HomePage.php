...
if(isset($_POST['search']))
{
      ...
      $query= $mysqli->query("SELECT projectName FROM projectslist WHERE projectName LIKE '%$searchq%'");
...
$query3 = $mysqli->query("SELECT * from projectslist WHERE projectName='$projectname'");
