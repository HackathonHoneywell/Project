...
$insertquery="INSERT INTO projectlist (projectId, projectName, description,fromD,toD,likes,moneyFunded,amountN,completed,categoryId,backers,phoneNo,email,link,exEndDate)VALUES ('$projectid', '$title', '$description','$fromdate','$todate',0,0,'$requiredfunds',0,1,0,'$phno','$emailid','','2018-06-10')";
